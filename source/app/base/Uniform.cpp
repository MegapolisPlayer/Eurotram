...
UniformMat4::UniformMat4(const Shader& aShader, const uint64_t aLocationOverride) noexcept
...
UniformMat3::UniformMat3(const Shader& aShader, const uint64_t aLocationOverride) noexcept
: Uniform(aShader, aLocationOverride) {}
...
UniformVec3::UniformVec3(const Shader& aShader, const uint64_t aLocationOverride) noexcept
: Uniform(aShader, aLocationOverride) {}
...
UniformVec4::UniformVec4(const Shader& aShader, const uint64_t aLocationOverride) noexcept
: Uniform(aShader, aLocationOverride) {}
...
UniformInt::UniformInt(const Shader& aShader, const uint64_t aLocationOverride) noexcept
: Uniform(aShader, aLocationOverride) {}
...
UniformFloat::UniformFloat(const Shader& aShader, const uint64_t aLocationOverride) noexcept
: Uniform(aShader, aLocationOverride) {}
