...
class Mesh {
	friend class Model;
public:
	Mesh(std::vector<Vertex>& aVerts, std::vector<GLuint>& aInds, GMSEntry* aEntry, std::vector<Bone>& aBones) noexcept;
...
private:
	...
	std::vector<Bone> mBones; //list of bones incl. their transforms
};
